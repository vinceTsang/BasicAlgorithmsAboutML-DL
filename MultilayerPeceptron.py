...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None, activation=T.tanh):
        ...
        #        For example, it is suggested that you should use
...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        # likelihood of the output of the model, computed in the logistic regression layer
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
   ...
   """
    ...
    # in MNIST, train_set: 50000, valid_set: 10000, test_set: 10000
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in range(n_train_batches):
            ...
            minibatch_avg_cost = train_model(minibatch_index) # one minibatch every epoch
            # iteration number
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    if (
                        ...
                        # iprove patience according to current iter, which is bigger enough
            ...
            if patience <= iter:
                # when the validation loss didn't improve significantly for a long time
                # we don't have patience to wait any longer
                done_looping = True
                break
